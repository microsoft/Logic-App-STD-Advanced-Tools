...
namespace LogicAppAdvancedTool
{
    partial class Program
    {
        private static void RestoreRunHistory(string workflowName)
        {
            ...
            string reviewerWorkflowRoot = "C:/home/site/wwwroot/";
            string reviewerWorkflowName = $"AutoGenerated_HistoryViewer_{DateTime.Now.ToString("yyyyMMddHHmmss")}";
            string reviewerWorkflowPath = $"{reviewerWorkflowRoot}{reviewerWorkflowName}";
            string reviewerWorkflowDefinition = GetEmbeddedResource("LogicAppAdvancedTool.Resources.EmptyDefinition.json");
